...
export function AccountSnapshotCard({
  ...
  return (
    <section className="mb-6">
      <div className="rounded-2xl bg-gradient-to-br from-white/[0.08] to-white/[0.04] backdrop-blur-2xl border border-white/15 p-5 shadow-[0_8px_24px_rgba(0,0,0,0.4)] group-hover:border-ultra-accent/70 transition-all duration-300">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div 
            ...
            onClick={(e) => {
              e.stopPropagation();
              router.push("/performance#equity");
            }}
          >
