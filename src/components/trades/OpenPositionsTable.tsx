          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-white/10">
                ...
                <th className="text-center py-3 px-4 text-xs font-medium text-white/50 uppercase tracking-wider">
                  Actions
                </th>
              </tr>
            </thead>
                  ...
                  >
                    ...
                    <td className="py-3 px-4 text-center">
                      <button
                        ...
                        className="px-3 py-1.5 bg-[#00FF7F] hover:bg-[#00E670] text-black text-xs font-semibold rounded-lg transition-colors"
                      >
                        Ask Agent
                      </button>
                    </td>
